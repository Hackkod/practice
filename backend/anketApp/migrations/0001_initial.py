    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_photo', models.ImageField(upload_to='images/%Y/%m/%d/')),
                ('job_position', models.CharField(max_length=1024)),
                ('hard_skills_id', models.ManyToManyField(related_name='ma_hard_skills_id', to='hardSkillApp.hardskill')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hard_skills_id', models.ManyToManyField(related_name='sa_hard_skills_id', to='hardSkillApp.hardskill')),
            ],
            options={
                'abstract': False,
            },
