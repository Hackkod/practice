<template>
  <modal-overlay @close="close" @submit="save">
    <modal-header>{{ mentor ? 'Редактирование наставника' : 'Создание нового наставника' }}</modal-header>
    <div class="form-content">
      ...
      <div class="second-column">
        ...
        <div class="form-group">
          ...
          <input v-model="form.job_position" required>
        </div>
      </div>
    </div>
  </modal-overlay>
